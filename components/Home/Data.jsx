  ...
  return (
    <div className="max-w-sm">
      <div className='flex flex-row gap-x-4 mb-4'>
        <h1 className="text-5xl font-bold text-title font-poppins sm:text-4xl">Vishal Jangid </h1>
      ...
      <h2 className="text-lg mb-4 font-normal text-title before:content-[''] before:bg-textColor
      before:h-1px before:w-10 before:flex
      
      ">Game Developer</h2>
      <p className="text-base mb-12 text-textColor text-justify">I'm a Unity Game Developer from India, pursuing a Master in Computer Engineering in Thailand and seeking a challenging position as a computer science engineer.</p>

        <Link href="#portfolio" passHref className={`${buttonVariants({ variant: "default" })} flex flex-row gap-x-3 px-5 py-8 gap-x-3 font-normal text-base sm:w-fit`}>
          <p>See Projects</p>
          <svg
            className=""
            xmlns="http://www.w3.org/2000/svg"
        ...
        <a href="/portfolio/Resume/Vishal_Jangid_Resume_2024.pdf" download={"Vishal_Jangid_Resume_2024.pdf"} >
        <Button className="ml-1 px-5 py-8 gap-x-3 font-normal text-base">
              Download CV
